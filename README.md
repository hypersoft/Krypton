...
[
  ...
  "XPR.bufferFromArrayBuffer: ƒ(ArrayBuffer object) => Buffer",
  "XPR.bufferLength: ƒ(Buffer buffer) => long",
  "XPR.bufferOutputStreamToBuffer: ƒ(Stream transferStream) => Buffer",
  "XPR.bufferToArrayBuffer: ƒ(Buffer transferShare) => ArrayBuffer",
